...
import NewEnrolmentView from "./dashboard/views/NewEnrolmentView";
import ShgMemberView from "./dashboard/views/ShgMemberView";
import GraphView from "./dashboard/views/GraphView";
import LhStatusView from "./dashboard/views/LhStatusView";
import ShgTrackingView from "./dashboard/views/ShgTrackingView";
import LhActivityFarmView from "./dashboard/views/LhActivityFarmView";
import LhActivityNonFarmView from "./dashboard/views/LhActivityNonFarmView";
import LhActivityLivestockView from "./dashboard/views/LhActivityLivestockView";
import LhActivityFisheryView from "./dashboard/views/LhActivityFisheryView";
